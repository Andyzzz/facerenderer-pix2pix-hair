...
parser.add_argument('--nepochs', type=int, default=70, help='saved model of which epochs')  # 180
...
# 0314加入stylegan生成的侧脸图像，重新训练模型，保存在checkpoint_parsing_0314里

model_path = "checkpoint_addhair_glw/netG_model_epoch_{}.pth".format(opt.nepochs)   # checkpoint_parsing   align
...
# tgt_dir = "/home/zhang/zydDataset/faceRendererData/testResults/2_facerender-pix2pix-hair/0324_addhair/"
image_dir = "/run/user/1000/gvfs/smb-share:server=cite-3d.local,share=share/zhangyidi/FaceRendererData/testResults/1_face-parsing/0517/crop/"
tgt_dir = "/run/user/1000/gvfs/smb-share:server=cite-3d.local,share=share/zhangyidi/FaceRendererData/testResults/1_face-parsing/0517/addhair/"
